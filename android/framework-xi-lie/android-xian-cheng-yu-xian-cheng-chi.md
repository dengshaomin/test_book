...
### 1 线程、线程池概述[¶](https://blog.yorek.xyz/android/framework/Android%E7%BA%BF%E7%A8%8B%E4%B8%8E%E7%BA%BF%E7%A8%8B%E6%B1%A0/#1) <a href="#1" id="1"></a>
...
### 2 Android中线程存在形态[¶](https://blog.yorek.xyz/android/framework/Android%E7%BA%BF%E7%A8%8B%E4%B8%8E%E7%BA%BF%E7%A8%8B%E6%B1%A0/#2-android) <a href="#2-android" id="2-android"></a>
...
#### 2.1 AsyncTask[¶](https://blog.yorek.xyz/android/framework/Android%E7%BA%BF%E7%A8%8B%E4%B8%8E%E7%BA%BF%E7%A8%8B%E6%B1%A0/#21-asynctask) <a href="#21-asynctask" id="21-asynctask"></a>
...
> 如果想要并行执行，我们可以通过调用`executeOnExecutor`来使用THREAD\_POOL\_EXECUTOR执行任务。
...
#### 2.2 AsyncTask的工作原理[¶](https://blog.yorek.xyz/android/framework/Android%E7%BA%BF%E7%A8%8B%E4%B8%8E%E7%BA%BF%E7%A8%8B%E6%B1%A0/#22-asynctask) <a href="#22-asynctask" id="22-asynctask"></a>
...
我们可以看到，该方法会通过`sHandler`发送一个MESSAGE\_POST\_RESULT消息。接着看`sHandler`的实现：
...
**`sHandler`是一个静态的Handler对象，为了能够切换执行线程，这就要求`sHandler`必须在主线程中进行创建。由于静态成员会在加载类的时候进行初始化，因此就这变相要求AsyncTask的类必须在主线程中进行加载。**`sHandler`在收到MESSAGE\_POST\_RESULT消息后，会调用`AsyncTask#finish`方法：
...
#### 2.3 IntentService[¶](https://blog.yorek.xyz/android/framework/Android%E7%BA%BF%E7%A8%8B%E4%B8%8E%E7%BA%BF%E7%A8%8B%E6%B1%A0/#23-intentservice) <a href="#23-intentservice" id="23-intentservice"></a>
...
### 3 Android中的线程池[¶](https://blog.yorek.xyz/android/framework/Android%E7%BA%BF%E7%A8%8B%E4%B8%8E%E7%BA%BF%E7%A8%8B%E6%B1%A0/#3-android) <a href="#3-android" id="3-android"></a>
...
#### 3.1 ThreadPoolExecutor[¶](https://blog.yorek.xyz/android/framework/Android%E7%BA%BF%E7%A8%8B%E4%B8%8E%E7%BA%BF%E7%A8%8B%E6%B1%A0/#31-threadpoolexecutor) <a href="#31-threadpoolexecutor" id="31-threadpoolexecutor"></a>
...
#### 3.2 线程池的分类[¶](https://blog.yorek.xyz/android/framework/Android%E7%BA%BF%E7%A8%8B%E4%B8%8E%E7%BA%BF%E7%A8%8B%E6%B1%A0/#32) <a href="#32" id="32"></a>
...
#### 3.3 线程池线程复用原理[¶](https://blog.yorek.xyz/android/framework/Android%E7%BA%BF%E7%A8%8B%E4%B8%8E%E7%BA%BF%E7%A8%8B%E6%B1%A0/#33) <a href="#33" id="33"></a>

![线程复用原理](https://blog.yorek.xyz/assets/images/android/thread\_reuse.png)
