...
### 1 RemoteViews的应用[¶](https://blog.yorek.xyz/android/framework/RemoteViews/#1-remoteviews) <a href="#1-remoteviews" id="1-remoteviews"></a>
...
#### 1.1 RemoteViews在通知栏上的应用[¶](https://blog.yorek.xyz/android/framework/RemoteViews/#11-remoteviews) <a href="#11-remoteviews" id="11-remoteviews"></a>
...
![系统默认的通知样式](https://blog.yorek.xyz/assets/images/android/remoteviews-system-notification.png)
...
![自定义通知样式](https://blog.yorek.xyz/assets/images/android/remoteviews-custom-notification.png)

我们只需要提供当前应用的包名和布局文件的资源id就可以创建一个`RemoteViews`。更新`RemoteViews`里面的View需要通过`RemoteViews`提供的一系列的方法来更新View。

#### 1.2 RemoteViews在桌面小部件上的应用[¶](https://blog.yorek.xyz/android/framework/RemoteViews/#12-remoteviews) <a href="#12-remoteviews" id="12-remoteviews"></a>
...
#### 1.3 PendingIntent概述[¶](https://blog.yorek.xyz/android/framework/RemoteViews/#13-pendingintent) <a href="#13-pendingintent" id="13-pendingintent"></a>
...
3. 如果`notify`的id值不同且`PendingIntent`匹配时
   ...
   2. FLAG\_CANCEL\_CURRENT\
      只有最新的通知可以打开，之前弹出的通知均无法打开
   3. FLAG\_UPDATE\_CURRENT\
      之前弹出的通知中的`PendingIntent`都会更新，最终它们和最新的一体通知保持完全一致，包括其中的extra data，并且这些通知都是可以打开的。

### 2 RemoteViews的内部机制[¶](https://blog.yorek.xyz/android/framework/RemoteViews/#2-remoteviews) <a href="#2-remoteviews" id="2-remoteviews"></a>
...
| setTextColor(int viewId, [@ColorInt](https://github.com/ColorInt) int color) | 设置TextView的文本颜色                  |
...
![RemoteViews的内部机制](https://blog.yorek.xyz/assets/images/android/remoteviews.png)

#### 2.1 RemoteViews的创建[¶](https://blog.yorek.xyz/android/framework/RemoteViews/#21-remoteviews) <a href="#21-remoteviews" id="21-remoteviews"></a>
...
#### 2.2 RemoteViews的样式、点击事件设置[¶](https://blog.yorek.xyz/android/framework/RemoteViews/#22-remoteviews) <a href="#22-remoteviews" id="22-remoteviews"></a>
...
#### 2.3 RemoteViews的渲染[¶](https://blog.yorek.xyz/android/framework/RemoteViews/#23-remoteviews) <a href="#23-remoteviews" id="23-remoteviews"></a>
...
#### 2.4 Action子类的具体实现[¶](https://blog.yorek.xyz/android/framework/RemoteViews/#24-action) <a href="#24-action" id="24-action"></a>
...
| setTextColor(int viewId, [@ColorInt](https://github.com/ColorInt) int color) | ReflectionAction        |
