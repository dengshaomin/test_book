...
![有点细节的时间轴](https://blog.yorek.xyz/assets/images/android/item-decoration-demo.png)
...
#### 1 RecyclerView.ItemDecoration[¶](https://blog.yorek.xyz/android/other/recyclerview-item-docoration/#1-recyclerviewitemdecoration) <a href="#1-recyclerviewitemdecoration" id="1-recyclerviewitemdecoration"></a>
...
#### 2 实现UI效果[¶](https://blog.yorek.xyz/android/other/recyclerview-item-docoration/#2-ui) <a href="#2-ui" id="2-ui"></a>
...
_注意，如果RecyclerView设置了header或者footer，需要注意一下下标的正确换算。_
