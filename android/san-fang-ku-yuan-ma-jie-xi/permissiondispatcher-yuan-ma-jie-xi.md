...
### 3. annotation模块[¶](https://blog.yorek.xyz/android/3rd-library/permissiondispatcher/#3-annotation) <a href="#3-annotation" id="3-annotation"></a>

annotation模块里面有5个注解复制至GitHub README.md的解释
