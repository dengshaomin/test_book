...
### UI 渲染测量[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#ui) <a href="#ui" id="ui"></a>
...
![ui\_2\_1](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_1.png)
...
#### 1. gfxinfo[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#1-gfxinfo) <a href="#1-gfxinfo" id="1-gfxinfo"></a>
...
![ui\_2\_2](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_2.png)

#### 2. SurfaceFlinger[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#2-surfaceflinger) <a href="#2-surfaceflinger" id="2-surfaceflinger"></a>
...
### UI 优化的常用手段[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#ui\_1) <a href="#ui_1" id="ui_1"></a>

让我们再重温一下 UI 渲染的阶段流程图，我们的目标是实现 60 fps，这意味着渲染的所有操作都必须在 16 ms（= 1000 ms／60 fps）内完成。

![ui\_2\_3](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_3.png)

所谓的 UI 优化，就是拆解渲染的各个阶段的耗时，找到瓶颈的地方，再加以优化。接下来我们一起来看看 UI 优化的一些常用的手段。

#### 1. 尽量使用硬件加速[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#1) <a href="#1" id="1"></a>
...
#### 2. Create View 优化[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#2-create-view) <a href="#2-create-view" id="2-create-view"></a>
...
![ui\_2\_4](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_4.png)
...
![ui\_2\_5](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_5.png)

#### 3. measure/layout 优化[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#3-measurelayout) <a href="#3-measurelayout" id="3-measurelayout"></a>
...
### UI 优化的进阶手段[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#ui\_2) <a href="#ui_2" id="ui_2"></a>

那对于其他的控件我们是不是也可以采用相同的方式？接下来我们一起来看看近两年新框架的做法，我来介绍一下 Facebook 的一个开源库 Litho 以及 Google 开源的 Flutter。

#### 1. Litho：异步布局[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#1-litho) <a href="#1-litho" id="1-litho"></a>
...
![ui\_2\_6](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_6.png)

Litho 如我前面提到的 PrecomputedText 一样，把 measure 和 layout 都放到了后台线程，只留下了必须要在主线程完成的 draw，这大大降低了 UI 线程的负载。它的渲染流水线如下：

![ui\_2\_7](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_7.png)
...
![ui\_2\_8](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_8.png)
...
![ui\_2\_9](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_9.png)
...
#### 2. Flutter：自己的布局 + 渲染引擎[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#2-flutter) <a href="#2-flutter" id="2-flutter"></a>

如下图所示，Litho 虽然通过使用自己的布局引擎 Yoga，一定程度上突破了系统的一些限制，但是在 draw 之后依然走的系统的渲染机制。

![ui\_2\_10](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_10.png)
...
![ui\_2\_11](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_11.png)
...
![ui\_2\_12](https://blog.yorek.xyz/assets/images/android/master/ui\_2\_12.png)
...
#### 3. RenderThread 与 RenderScript[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#3-renderthread-renderscript) <a href="#3-renderthread-renderscript" id="3-renderthread-renderscript"></a>

在 Android 5.0，系统增加了 RenderThread，对于 ViewPropertyAnimator 和 CircularReveal 动画，我们可以使用[RenderThead 实现动画的异步渲染](https://mp.weixin.qq.com/s/o-e0MvrJbVS\_0HHHRf43zQ)。当主线程阻塞的时候，普通动画会出现明显的丢帧卡顿，而使用 RenderThread 渲染的动画即使阻塞了主线程仍不受影响。
...
### 总结[¶](https://blog.yorek.xyz/android/paid/master/ui\_2/#\_5) <a href="#_5" id="_5"></a>
