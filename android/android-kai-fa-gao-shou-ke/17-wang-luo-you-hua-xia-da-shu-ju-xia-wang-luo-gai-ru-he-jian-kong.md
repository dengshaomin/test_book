...
### 移动端监控[¶](https://blog.yorek.xyz/android/paid/master/network\_3/#\_1) <a href="#_1" id="_1"></a>

对于移动端来说，我们可能会有各种各样的网络请求。即使使用了 OkHttp 网络库，也可能会有一些开发人员或者第三方组件使用了系统的网络库。那应该如何统一的监控客户端的所有的网络请求呢？

#### 1. 如何监控网络[¶](https://blog.yorek.xyz/android/paid/master/network\_3/#1) <a href="#1" id="1"></a>
...
“socketConnect”方法对应的 Native 方法定义在[PlainSocketImpl.c](http://androidxref.com/7.0.0\_r1/xref/libcore/ojluni/src/main/native/PlainSocketImpl.c)，查看makefile可以知道它们会编译在 libopenjdk.so 中。不过在 Android 8.0，整个调用流程又完全改变了。为了兼容性考虑，我们直接 PLT Hook 内存的所有 so，但是需要排除掉 Socket 函数本身所在的 libc.so。
...
![network\_3\_1](https://blog.yorek.xyz/assets/images/android/master/network\_3\_1.png)
...
#### 2. 如何监控流量[¶](https://blog.yorek.xyz/android/paid/master/network\_3/#2) <a href="#2" id="2"></a>
...
* iPhone：打开拨号界面，输入“\*[3001#12345](https://github.com/squidfunk/3001/issues/12345)#\*”，然后按拨号键。
* Android 手机：打开拨号界面，输入“\*#\*[#4636](https://github.com/squidfunk/mkdocs-material/issues/4636)#\*#\*”，然后按拨号键（可进入工程测试模式，部分版本可能不支持）。

![network\_3\_2](https://blog.yorek.xyz/assets/images/android/master/network\_3\_2.png)
...
### 大网络平台监控[¶](https://blog.yorek.xyz/android/paid/master/network\_3/#\_4) <a href="#_4" id="_4"></a>
...
#### 1. 客户端监控[¶](https://blog.yorek.xyz/android/paid/master/network\_3/#1\_1) <a href="#1_1" id="1_1"></a>
...
![network\_3\_3](https://blog.yorek.xyz/assets/images/android/master/network\_3\_3.png)
...
#### 2. 接入层监控[¶](https://blog.yorek.xyz/android/paid/master/network\_3/#2\_1) <a href="#2_1" id="2_1"></a>

客户端监控的数据会比接入层更加丰富，因为有可能会出现部分数据还没到达接入层就已经被打回，例如运营商劫持的情况。

![network\_3\_4](https://blog.yorek.xyz/assets/images/android/master/network\_3\_4.png)
...
#### 3. 监控报警[¶](https://blog.yorek.xyz/android/paid/master/network\_3/#3) <a href="#3" id="3"></a>
...
![network\_3\_5](https://blog.yorek.xyz/assets/images/android/master/network\_3\_5.png)
...
### 总结[¶](https://blog.yorek.xyz/android/paid/master/network\_3/#\_5) <a href="#_5" id="_5"></a>
...
### 课后作业[¶](https://blog.yorek.xyz/android/paid/master/network\_3/#\_6) <a href="#_6" id="_6"></a>
