...
### 启动分析[¶](https://blog.yorek.xyz/android/paid/master/start\_1/#\_1) <a href="#_1" id="_1"></a>

在真正动手开始优化之前，我们应该先搞清楚从用户点击图标开始，整个启动过程经过哪几个关键阶段，又会给用户带来哪些体验问题。

#### 1. 启动过程分析[¶](https://blog.yorek.xyz/android/paid/master/start\_1/#1) <a href="#1" id="1"></a>

![start\_1\_1](https://blog.yorek.xyz/assets/images/android/master/start\_1\_1.png)
...
#### 2. 启动问题分析[¶](https://blog.yorek.xyz/android/paid/master/start\_1/#2) <a href="#2" id="2"></a>
...
### 启动优化[¶](https://blog.yorek.xyz/android/paid/master/start\_1/#\_2) <a href="#_2" id="_2"></a>

启动速度优化的方法和卡顿优化基本相同，不过因为启动实在是太重要了，我们会更加“精打细算”。我们希望启动期间加载的每个功能和业务都是必须的，它们的实现都是经过“千锤百炼”的，特别是在中低端机上面的表现。

#### 1. 优化工具[¶](https://blog.yorek.xyz/android/paid/master/start\_1/#1\_1) <a href="#1_1" id="1_1"></a>
...
#### 2. 优化方式[¶](https://blog.yorek.xyz/android/paid/master/start\_1/#2\_1) <a href="#2_1" id="2_1"></a>
...
*   线程优化\
    ...
    ![start\_1\_2](https://blog.yorek.xyz/assets/images/android/master/start\_1\_2.png)\
    ...
    ![start\_1\_3](https://blog.yorek.xyz/assets/images/android/master/start\_1\_3.png)
*   GC 优化\
    ...
    ![start\_1\_4](https://blog.yorek.xyz/assets/images/android/master/start\_1\_4.png)\
...
### 总结[¶](https://blog.yorek.xyz/android/paid/master/start\_1/#\_3) <a href="#_3" id="_3"></a>
...
### 课后作业[¶](https://blog.yorek.xyz/android/paid/master/start\_1/#\_4) <a href="#_4" id="_4"></a>
